...
public class TransactionEventBody extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private mvp.kafka.avro.model.TransactionType transactionType;
  /** The timestamp when the transaction event was generated */
  private long date;
  /** The amount of money sent in this transaction */
  private long amount;
   ...
   * @param transactionType Transaction type of the payment
   * @param date The timestamp when the transaction event was generated
   * @param amount The amount of money sent in this transaction
   * @param currency Transaction currency
   * @param description Description of the transaction purpose
   */
  public TransactionEventBody(java.lang.String transactionId, java.lang.String userId, mvp.kafka.avro.model.TransactionType transactionType, java.lang.Long date, java.lang.Long amount, java.lang.String currency, java.lang.String description) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: transactionType = (mvp.kafka.avro.model.TransactionType)value$; break;
   ...
   * @return Transaction type of the payment
   */
  public mvp.kafka.avro.model.TransactionType getTransactionType() {
   ...
   * @param value the value to set.
   */
  public void setTransactionType(mvp.kafka.avro.model.TransactionType value) {
   ...
   * @return The amount of money sent in this transaction
   */
   ...
   */
  public static mvp.kafka.avro.model.TransactionEventBody.Builder newBuilder() {
    return new mvp.kafka.avro.model.TransactionEventBody.Builder();
  }
   ...
   * @return A new TransactionEventBody RecordBuilder
   */
  public static mvp.kafka.avro.model.TransactionEventBody.Builder newBuilder(mvp.kafka.avro.model.TransactionEventBody.Builder other) {
    if (other == null) {
      return new mvp.kafka.avro.model.TransactionEventBody.Builder();
    } else {
      return new mvp.kafka.avro.model.TransactionEventBody.Builder(other);
    }
  }
   ...
   * @return A new TransactionEventBody RecordBuilder
   */
  public static mvp.kafka.avro.model.TransactionEventBody.Builder newBuilder(mvp.kafka.avro.model.TransactionEventBody other) {
    if (other == null) {
      return new mvp.kafka.avro.model.TransactionEventBody.Builder();
    } else {
      return new mvp.kafka.avro.model.TransactionEventBody.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TransactionEventBody>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(mvp.kafka.avro.model.TransactionEventBody.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(mvp.kafka.avro.model.TransactionEventBody other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.transactionId)) {
        this.transactionId = data().deepCopy(fields()[0].schema(), other.transactionId);
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder setTransactionId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder clearTransactionId() {
      transactionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder setUserId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder setTransactionType(mvp.kafka.avro.model.TransactionType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder clearTransactionType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder setDate(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder clearDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder setAmount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder setCurrency(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder clearCurrency() {
      currency = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder setDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEventBody.Builder clearDescription() {
      description = null;
    ...
    public TransactionEventBody build() {
      try {
        ...
        record.transactionType = fieldSetFlags()[2] ? this.transactionType : (mvp.kafka.avro.model.TransactionType) defaultValue(fields()[2]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.transactionType = mvp.kafka.avro.model.TransactionType.values()[in.readEnum()];
