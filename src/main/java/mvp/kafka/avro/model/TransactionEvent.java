...
/** Dummy Avro schema for a message event  called 'TransactionEvent', that will generate the 'model' classes in the specified directory */
...
public class TransactionEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7843130001004456598L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TransactionEvent\",\"namespace\":\"mvp.kafka.avro.model\",\"doc\":\"Dummy Avro schema for a message event  called 'TransactionEvent', that will generate the 'model' classes in the specified directory\",\"fields\":[{\"name\":\"header\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"TransactionEventHeader\",\"doc\":\"Default information\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"GUID (UUID) of the event making it globally identifiable\"},{\"name\":\"sourceSystem\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Source system which created the event\"},{\"name\":\"createdAt\",\"type\":\"long\",\"doc\":\"Event timestamp creation in epoch format\"}]}],\"default\":null},{\"name\":\"body\",\"type\":{\"type\":\"record\",\"name\":\"TransactionEventBody\",\"doc\":\"Body information of the event\",\"fields\":[{\"name\":\"transactionId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"UUID of the transaction\"},{\"name\":\"userId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"UUID of the user that initiated the transaction\"},{\"name\":\"transactionType\",\"type\":{\"type\":\"enum\",\"name\":\"TransactionType\",\"symbols\":[\"INSTANT_PAYMENT\",\"SEPA\",\"CREDIT_CARD\"]},\"doc\":\"Transaction type of the payment\"},{\"name\":\"date\",\"type\":\"long\",\"doc\":\"The timestamp when the transaction event was generated\"},{\"name\":\"amount\",\"type\":\"long\",\"doc\":\"The amount of money sent in this transaction\"},{\"name\":\"currency\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"Transaction currency\",\"default\":null},{\"name\":\"description\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"Description of the transaction purpose\",\"default\":null}]},\"doc\":\"body of transaction event\"}]}");
  ...
  private mvp.kafka.avro.model.TransactionEventHeader header;
  /** body of transaction event */
  private mvp.kafka.avro.model.TransactionEventBody body;
   ...
   */
  public TransactionEvent(mvp.kafka.avro.model.TransactionEventHeader header, mvp.kafka.avro.model.TransactionEventBody body) {
    this.header = header;
    this.body = body;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: header = (mvp.kafka.avro.model.TransactionEventHeader)value$; break;
    case 1: body = (mvp.kafka.avro.model.TransactionEventBody)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public mvp.kafka.avro.model.TransactionEventHeader getHeader() {
    return header;
  }
   ...
   */
  public void setHeader(mvp.kafka.avro.model.TransactionEventHeader value) {
    this.header = value;
  }
   ...
   */
  public mvp.kafka.avro.model.TransactionEventBody getBody() {
    return body;
  }
   ...
   * @param value the value to set.
   */
  public void setBody(mvp.kafka.avro.model.TransactionEventBody value) {
    this.body = value;
  }
   ...
   */
  public static mvp.kafka.avro.model.TransactionEvent.Builder newBuilder() {
    return new mvp.kafka.avro.model.TransactionEvent.Builder();
  }
   ...
   * @return A new TransactionEvent RecordBuilder
   */
  public static mvp.kafka.avro.model.TransactionEvent.Builder newBuilder(mvp.kafka.avro.model.TransactionEvent.Builder other) {
    if (other == null) {
      return new mvp.kafka.avro.model.TransactionEvent.Builder();
    } else {
      return new mvp.kafka.avro.model.TransactionEvent.Builder(other);
    }
  }
   ...
   * @return A new TransactionEvent RecordBuilder
   */
  public static mvp.kafka.avro.model.TransactionEvent.Builder newBuilder(mvp.kafka.avro.model.TransactionEvent other) {
    if (other == null) {
      return new mvp.kafka.avro.model.TransactionEvent.Builder();
    } else {
      return new mvp.kafka.avro.model.TransactionEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TransactionEvent>
    ...
    private mvp.kafka.avro.model.TransactionEventHeader header;
    private mvp.kafka.avro.model.TransactionEventHeader.Builder headerBuilder;
    /** body of transaction event */
    private mvp.kafka.avro.model.TransactionEventBody body;
    private mvp.kafka.avro.model.TransactionEventBody.Builder bodyBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(mvp.kafka.avro.model.TransactionEvent.Builder other) {
      super(other);
      ...
      if (other.hasHeaderBuilder()) {
        this.headerBuilder = mvp.kafka.avro.model.TransactionEventHeader.newBuilder(other.getHeaderBuilder());
      }
      ...
      if (other.hasBodyBuilder()) {
        this.bodyBuilder = mvp.kafka.avro.model.TransactionEventBody.newBuilder(other.getBodyBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(mvp.kafka.avro.model.TransactionEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.header)) {
        this.header = data().deepCopy(fields()[0].schema(), other.header);
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEvent.Builder setHeader(mvp.kafka.avro.model.TransactionEventHeader value) {
     ...
     * @return This builder.
     */
    public mvp.kafka.avro.model.TransactionEventHeader.Builder getHeaderBuilder() {
      if (headerBuilder == null) {
        if (hasHeader()) {
          setHeaderBuilder(mvp.kafka.avro.model.TransactionEventHeader.newBuilder(header));
        } else {
          setHeaderBuilder(mvp.kafka.avro.model.TransactionEventHeader.newBuilder());
        }
      }
    ...
    public mvp.kafka.avro.model.TransactionEvent.Builder setHeaderBuilder(mvp.kafka.avro.model.TransactionEventHeader.Builder value) {
      clearHeader();
      headerBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEvent.Builder clearHeader() {
      header = null;
      headerBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEvent.Builder setBody(mvp.kafka.avro.model.TransactionEventBody value) {
     ...
     * @return This builder.
     */
    public mvp.kafka.avro.model.TransactionEventBody.Builder getBodyBuilder() {
      if (bodyBuilder == null) {
        if (hasBody()) {
          setBodyBuilder(mvp.kafka.avro.model.TransactionEventBody.newBuilder(body));
        } else {
          setBodyBuilder(mvp.kafka.avro.model.TransactionEventBody.newBuilder());
        }
      }
      return bodyBuilder;
    }
    ...
    public mvp.kafka.avro.model.TransactionEvent.Builder setBodyBuilder(mvp.kafka.avro.model.TransactionEventBody.Builder value) {
      clearBody();
      bodyBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public mvp.kafka.avro.model.TransactionEvent.Builder clearBody() {
      body = null;
      bodyBuilder = null;
    ...
    public TransactionEvent build() {
      try {
        ...
        if (headerBuilder != null) {
          ...
          record.header = fieldSetFlags()[0] ? this.header : (mvp.kafka.avro.model.TransactionEventHeader) defaultValue(fields()[0]);
        }
        if (bodyBuilder != null) {
          try {
          ...
          record.body = fieldSetFlags()[1] ? this.body : (mvp.kafka.avro.model.TransactionEventBody) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.header == null) {
          this.header = new mvp.kafka.avro.model.TransactionEventHeader();
        }
        this.header.customDecode(in);
      }

      if (this.body == null) {
        this.body = new mvp.kafka.avro.model.TransactionEventBody();
      }
